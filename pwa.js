...
// ========================================
(function(){
  ['study-page.css','study-plans.css','study-sessions.css'].forEach((name,i)=>{const style=document.createElement('link');style.rel='stylesheet';style.href='./'+name+'?v=20260917'+i;document.head.appendChild(style);});
  const scripts=[
    ...
    './study-set-button-fix.js?v=20260917'
  ];
  scripts.forEach(src=>{
