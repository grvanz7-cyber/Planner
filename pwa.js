...
(function(){
  ...
  const scripts=[
    ...
    './study-page.js?v=20260917',
    './study-plans.js?v=20260917',
    './study-sessions.js?v=20260917',
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', async () => {
    try {
      const registration = await navigator.serviceWorker.register('./service-worker.js?v=20260917');
