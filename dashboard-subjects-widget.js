...
(function installDashboardSubjectWidget(){
    ...
    function render(){
        ...
        subjects.forEach(s=>{
            ...
            const row=document.createElement('div');row.className='dashboard-subject-row';row.style.setProperty('--subject-color',s.colour||'var(--planner-accent, #304b8a)');row.tabIndex=0;row.setAttribute('role','button');row.setAttribute('aria-label',`Open ${s.name||'subject'}`);
