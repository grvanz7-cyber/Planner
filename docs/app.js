(() => {
  const pages = {
    ...
    subjects: { title: "Subjects", subtitle: "Your courses, units, grades, and academic progress.", cards: [["Subjects foundation", "Subjects and units will be connected to the data model in Stage 2 and Stage 3."]] },
